document.addEventListener('DOMContentLoaded', function () {
    ...
    addBookForm.addEventListener('submit', function (event) {
        ...
        // Validation: Ensure that all required fields are filled and that year/quantity are numbers
        if (!title || !author || !genre || isNaN(year) || isNaN(quantity) || !status) {
            return;
        }
        ...
        // Render the updated book list and close the modal
        renderBooks();
        modal.style.display = 'none';
    ...
    // Call the function immediately to display the time and date on load
    updateTimeAndDate();
